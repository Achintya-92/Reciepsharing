...
export default function Home(){
  ...
  useEffect(()=>{
    fetch(`http://localhost:5000/api/recipe/home/retrieve`).then(res=>res.json()).then(data=>setRecipes(data)).catch(err=>console.error(err));
  },[]);
return(
          ...
          <div key={r._id} className="col-lg-4 col-md-6 col"> 
            ...
            <div className="card h-100 shadow-sm">
              ...
              <div style={{ overflow: "hidden", height: 220 }}>
                ...
                <img
                  src={r.imgSrc ? `http://localhost:5000${r.imgSrc}` : "/placeholder.png"}
              ...
              <div className="card-body d-flex flex-column">
                ...
                <p className="card-text" style={{ flexGrow: 1 }}><b>Instructions: </b>
                 ...
                 {r.preptime}
                  ...
                  <p className="card-text" style={{ flexGrow: 1 }}><b>Likes: </b>
                 {r.preptime}
                </p>
